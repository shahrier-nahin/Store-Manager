...
<html lang="en">
  ...
  <nav class="navbar navbar-dark bg-dark">
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="insert into `customers` (cust_id, cust_name, cust_address, cust_number) values('$cu_id','$cu_name', '$cu_address', '$cu_number')";
...
<form method = "post">
  <div class="form-group">
    ...
    placeholder="Enter ID" name="cust_id">
  </div>

  <div class="form-group">
    <label>Customer's Name</label>
    <input type="text" class="form-control" 
    placeholder="Enter customer's Name" name="cust_name">
  </div>

  <div class="form-group">
    <label>Contact Number</label>
    <input type="tel" class="form-control" 
    placeholder="Enter Phone Number" name="cust_number">
  </div>

  <div class="form-group">
    <label>Address</label>
    <input type="tel" class="form-control" 
    placeholder="Enter Address" name="cust_address">
  </div>
