...
<button class="btn btn-outline-light my-2 my-sm-0" onclick="logout()">Logout</button>
      ...
      <div class="content">  
      <button class="btn btn-outline-dark float-left mb-3"><a href="insert_supplier.php" class="text-dark">Add Supplier</a></button> 
<table class="table">
...
if($result){
  while($row=mysqli_fetch_assoc($result)){
    ...
    <td>
      ...
      <button class="btn btn-outline-secondary"><a href="update_supplier.php? updateid='.$id.'"class="text-dark">Update</a></button>
      <button class="btn btn-outline-secondary"><a href="delete_supplier.php? deleteid='.$id.'"class="text-dark">Delete</a></button>
    </td>
  </tr>';
  }
}
