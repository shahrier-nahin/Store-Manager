...
<html lang="en">
  ...
  <nav class="navbar navbar-dark bg-dark">
      ...
      <div class="content"> 
      <button class="btn btn-outline-dark float-left mb-3"><a href="insert_orders.php" class="text-dark">Add Orders</a></button>     
<table class="table">
...
if($result){
  while($row=mysqli_fetch_assoc($result)){
    ...
    <td>
      ...
      <button class="btn btn-outline-secondary"><a href="update_orders.php? updateid='.$id.'"class="text-dark">Update</a></button>
      <button class="btn btn-outline-secondary"><a href="delete_orders.php? deleteid='.$id.'"class="text-dark">Delete</a></button>
    </td>
  </tr>';
  }
}
